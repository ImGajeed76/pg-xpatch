...
--
-- Previous changes (0.6.3 -> 0.7.0):
--   - New function: xpatch.warm_cache_parallel() — C implementation of cache
--     warming using PostgreSQL dynamic background workers for parallel cache
--     population. Discovers groups and keyframe sections, distributes work
--     across N workers via lock-free shared work queue in dynamic shared memory.
--   - New GUC: pg_xpatch.warm_cache_workers (default 4, PGC_USERSET)
--   - Existing xpatch.warm_cache() PL/pgSQL function preserved as-is.
...
-- ============================================================================
-- Parallel cache warming via dynamic background workers (v0.7.0)
-- ============================================================================
