...
--
-- Changes from 0.6.0:
--   - Fixed REPEATABLE READ / SERIALIZABLE isolation
--   - Fixed use-after-free in DELETE with TEXT/VARCHAR/BYTEA group keys
--   - Fixed hint bit write under shared buffer lock
--   - Fixed xpatch_get_max_seq counting same-transaction deleted tuples
