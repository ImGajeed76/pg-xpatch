...
BEGIN
    ...
    property := '--- Table Info ---'; value := ''; RETURN NEXT;
    ...
    property := '--- Configuration ---'; value := ''; RETURN NEXT;
    ...
    -- Schema section
    property := '--- Schema ---'; value := ''; RETURN NEXT;
    FOR v_col IN 
    ...
    property := '--- Storage Stats ---'; value := ''; RETURN NEXT;
